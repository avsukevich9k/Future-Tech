...
class Select extends BaseComponent {
    ...
    fixDropDownPosition() {
        ...
        this.dropdownElement.classList.toggle(this.stateAttributes.isOnTheLeftSide, isButtonOnTheLeftViewportSide)
        this.dropdownElement.classList.toggle(this.stateAttributes.isOnTheRightSide, !isButtonOnTheLeftViewportSide)
    }
